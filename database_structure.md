...
| `content_text`        | `TEXT`              | `NULL` diperbolehkan                                         | Hasil ekstraksi teks dari slide. Bisa berasal dari OCR, VLM, atau parser PDF biasa. Ini yang akan di-embedding.                                                                                              |
...
| `content_base_64`     | `TEXT`              | `NULL` diperbolehkan                                         | Representasi slide sebagai image yang di-encode base64. Berguna untuk: audit visual, VLM revisit, atau front-end yang ingin menampilkan slide asli. Bila storage jadi berat, bisa diganti jadi `image_path`. |
