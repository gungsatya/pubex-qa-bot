...
| `file_md_path`    | `VARCHAR`         | `NULL` diperbolehkan                                         | Lokasi file markdown hasil konversi Docling, misalnya `src/data/documents/2025/ABMM/slides/<document_id>/document.md`.                                             |
